...
const Home = () => {
  ...
  return (
    <>
      <div className="bg-neutral-700 text-white shadow-2xl p-4 pl-10 pr-10 mb-8">
      ...
      <div className="flex items-center space-x-4  p-6">
        ...
        >
          <Card className="w-32 h-48 ml-4 bg-black flex items-center justify-center relative">
            <img
              src="/movie-logo.png"
              alt="Series icon"
              width={32}
